...
public sealed class DateTimeExtendTests
{
    ...
    public void StartOfPeriod_Month_ReturnsStartOfMonth()
    {
        ...
        Assert.Equal(new DateTime(2023, 5, 1), result);
    }

    [Fact]
    public void StartOfPeriod_Week_ReturnsStartOfWeek()
    {
        var date = new DateTime(2023, 5, 17); // Wednesday
        var culture = new CultureInfo("en-US");
        Thread.CurrentThread.CurrentCulture = culture;
        var result = date.StartOfPeriod(EPeriodType.Week);
        Assert.Equal(new DateTime(2023, 5, 14), result); // Sunday
    }
    ...
    public void StartOfPeriod_Hour_ReturnsStartOfHour()
    {
        ...
        Assert.Equal(new DateTime(2023, 5, 15, 10, 0, 0), result);
    }
    ...
    public void StartOfPeriod_Minute_ReturnsStartOfMinute()
    {
        ...
        Assert.Equal(new DateTime(2023, 5, 15, 10, 30, 0), result);
    }

    [Fact]
    public void StartOfPeriod_Second_ReturnsStartOfSecond()
    {
        var date = new DateTime(2023, 5, 15, 10, 30, 45, 123);
        var result = date.StartOfPeriod(EPeriodType.Second);
        Assert.Equal(new DateTime(2023, 5, 15, 10, 30, 45), result);
    }
    ...
    public void DateAdd_AddsCorrectly()
    {
        ...
        Assert.Equal(new DateTime(2024, 1, 1), date.DateAdd(EPeriodType.Year, 1));
        Assert.Equal(new DateTime(2023, 4, 1), date.DateAdd(EPeriodType.Quarter, 1));
        Assert.Equal(new DateTime(2023, 2, 1), date.DateAdd(EPeriodType.Month, 1));
        Assert.Equal(new DateTime(2023, 1, 8), date.DateAdd(EPeriodType.Week, 1));
        Assert.Equal(new DateTime(2023, 1, 2), date.DateAdd(EPeriodType.Day, 1));
        Assert.Equal(new DateTime(2023, 1, 1, 1, 0, 0), date.DateAdd(EPeriodType.Hour, 1));
        Assert.Equal(new DateTime(2023, 1, 1, 0, 1, 0), date.DateAdd(EPeriodType.Minute, 1));
        Assert.Equal(new DateTime(2023, 1, 1, 0, 0, 1), date.DateAdd(EPeriodType.Second, 1));
    }

    [Fact]
    public void DateDiff_ReturnsCorrectDifference()
    {
        var d1 = new DateTime(2023, 5, 15, 10, 30, 45);
        var d2 = new DateTime(2020, 1, 1, 8, 15, 30);
    ...
    {
        var d1 = new DateTime(2023, 5, 15, 10, 30, 45, 500);
        var d2 = new DateTime(2020, 1, 1, 8, 15, 30, 250);
    ...
    {
        var forDate = new DateTime(2023, 5, 15);
        var startAtDate = new DateTime(2020, 1, 1);
        ...
        Assert.Equal(new DateTime(2023, 3, 1), result);
    }
}