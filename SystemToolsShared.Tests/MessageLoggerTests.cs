...
public sealed class MessageLoggerTests
{
    ...
    {
        public TestableMessageLogger(ILogger? logger, IMessagesDataManager? messagesDataManager, string? userName,
            bool useConsole) : base(logger, messagesDataManager, userName, useConsole)
        {
        }

        public new async ValueTask
            LogInfoAndSendMessage(string message, CancellationToken cancellationToken = default) =>
            await base.LogInfoAndSendMessage(message, cancellationToken);

        public new async ValueTask LogInfoAndSendMessage(string message, object? arg1,
            CancellationToken cancellationToken = default) =>
            await base.LogInfoAndSendMessage(message, arg1, cancellationToken);

        public new async ValueTask LogInfoAndSendMessage(string message, object? arg1, object? arg2,
            CancellationToken cancellationToken = default) =>
            await base.LogInfoAndSendMessage(message, arg1, arg2, cancellationToken);

        public new async ValueTask LogInfoAndSendMessage(string message, object? arg1, object? arg2, object? arg3,
            CancellationToken cancellationToken = default) =>
        ...
        public new async ValueTask LogWarningAndSendMessage(string message,
            CancellationToken cancellationToken = default) =>
            await base.LogWarningAndSendMessage(message, cancellationToken);

        public new async ValueTask LogWarningAndSendMessage(string message, object? arg1,
            CancellationToken cancellationToken = default) =>
            await base.LogWarningAndSendMessage(message, arg1, cancellationToken);

        public new async ValueTask LogWarningAndSendMessage(string message, object? arg1, object? arg2,
            CancellationToken cancellationToken = default) =>
            await base.LogWarningAndSendMessage(message, arg1, arg2, cancellationToken);

        public new async ValueTask<IEnumerable<Err>> LogErrorAndSendMessageFromError(string errorCode, string message,
            CancellationToken cancellationToken = default) =>
            await base.LogErrorAndSendMessageFromError(errorCode, message, cancellationToken);

        public new async ValueTask<IEnumerable<Err>> LogErrorAndSendMessageFromError(Err error,
            CancellationToken cancellationToken = default) =>
            await base.LogErrorAndSendMessageFromError(error, cancellationToken);

        public new async ValueTask<IEnumerable<Err>> LogErrorAndSendMessageFromException(Exception ex,
    ...
    public async Task LogErrorAndSendMessageFromException_ReturnsErrAndSends()
    {
        ...
        _mockMessages.Verify(
            m => m.SendMessage(_userName, It.Is<string>(s => s.Contains("TestMethod")), It.IsAny<CancellationToken>()),
            Times.Once);
    }
}